    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Berth Cancellation Form</h2>
                    <form action="cancel" method="POST">
                        ...
                        <div class="form-check">
                            ...
                            <b>I, hereby declare that the above given information are true to the fullest and wish to cancel the Booking I made prior</b>
                        </div>
                        <div class="p-t-30">
                            <div class="row row-space">
