    ...
    <div class="page-wrapper bg-gra-02 p-t-130 p-b-100 font-poppins">
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <h2 class="title">Berth Booking Form</h2>
                    <form action="booking" method="POST">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Vessel Owner</label>
                                    <input class="input--style-4" type="text" name="vesselowner">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Phone</label>
                                    <input class="input--style-4" type="text" name="ownerphone" maxlength="10" min="10">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="agencyname">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Agent Name</label>
                                    <input class="input--style-4" type="text" name="agentname">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Agency Email</label>
                                    <input class="input--style-4" type="email" name="agencyemail">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Agent Phone</label>
                                    <input class="input--style-4" type="text" name="agentphone" maxlength="10" min="10">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Agency City</label>
                                    <input class="input--style-4" type="text" name="agentcity">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Agency Pincode</label>
                                    <input class="input--style-4" type="text" name="agencypincode" maxlength="6" min="6">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                        ...
                        <div class="form-check">
                            ...
                            <center><b>I, hereby declare that the above given information are true to the fullest</b>
                        </div>
                        <div class="p-t-30">
                            <div class="row row-space">
